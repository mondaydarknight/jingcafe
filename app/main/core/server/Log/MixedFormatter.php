 ...
 *
 * This class extends the basic Monolog LineFormatter class, and provides basically the same functionally but with one exception:
 *
...
class MixedFormatter extends LineFormatter {
 	...
 	/**
 	 * Return the JSON representatino of a value
 	 * 
 	 * @param mixed 			$data
